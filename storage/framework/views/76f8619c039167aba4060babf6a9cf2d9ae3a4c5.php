<form action="<?php echo e(route('area.update' , ['id' => $item->id])); ?>" method="post">
  <?php echo csrf_field(); ?>
              ...
              <div class="col-md-8 ml-auto mr-auto">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="region_id">
                    ...
                    <option <?php if($item->region_id == $region->id): ?> selected <?php endif; ?> value="<?php echo e($region->id); ?>"><?php echo e($region->$name_l); ?></option>
...
<?php /**PATH /home/tsul/domains/qabul2023-litsey.tsul.uz/public_html/resources/views/superadmin/pages/datas/area/edit.blade.php ENDPATH**/ ?>