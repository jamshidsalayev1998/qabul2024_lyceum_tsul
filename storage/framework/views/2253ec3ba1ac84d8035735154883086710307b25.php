<form class="iwla<?php echo e($item->id); ?>" action="<?php echo e(route('edutype.update' , ['id' => $item->id])); ?>" method="post">
  <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Ta`lim turini o`zgartirish</h4>
...
<?php /**PATH /home/tsul/domains/qabul2023-litsey.tsul.uz/public_html/resources/views/superadmin/pages/datas/edutype/edit.blade.php ENDPATH**/ ?>