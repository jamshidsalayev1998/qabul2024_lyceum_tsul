<form action="<?php echo e(route('langtype.update' , ['id' => $item->id])); ?>" method="post">
  <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Talim tilini o`zgartirish</h4>
...
</form><?php /**PATH /home/tsul/domains/qabul2023-litsey.tsul.uz/public_html/resources/views/superadmin/pages/datas/languagetype/edit.blade.php ENDPATH**/ ?>