                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form_out">
                            <div class="form_all">
                            	...
                            	<form class="form_login" method="POST" action="<?php echo e(route('register')); ?>">
									<?php echo csrf_field(); ?>
	                                <div class="item_form">
...
$message = $__bag->first($__errorArgs[0]); ?><span class="error">!<?php echo e($message); ?> <?php if(session('error')): ?> <?php echo e(session('error')); ?> <?php endif; ?> </span><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                 ...
                                 <button class="login"><?php echo app('translator')->get('login.Sign up'); ?></button>
...
<?php echo $__env->make('admin.layouts.login_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tsul/domains/qabul2023-litsey.tsul.uz/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>