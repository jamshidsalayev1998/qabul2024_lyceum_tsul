...
<?php $locale = App::getLocale(); $name_l = 'name_'.$locale; ?>
                ...
                <div class="applicants" style="background-color: transparent !important;">
        			...
        			<?php echo $__env->make('superadmin.pages.datas.country.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    ...
                                    <tbody>
				                        ...
				                        <tr>
				                            ...
				                            <td class="text-left">
				                                ...
				                                <?php echo $__env->make('superadmin.pages.datas.country.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				                            </td>
...
$('.faculty_switcher').change(function(){
    ...
    var tt = confirm('Mamlakat holatini o`zgartirasizmi ?');
    if(tt){
        var url = '/change-country-status/'+id+'/'+value;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tsul/domains/qabul2023-litsey.tsul.uz/public_html/resources/views/superadmin/pages/datas/country/index.blade.php ENDPATH**/ ?>